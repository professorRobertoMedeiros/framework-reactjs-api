...
const AuthService_1 = require("../core/auth/AuthService");
const UserRepository_1 = require("../use-cases/user/repository/UserRepository");
...
router.post('/register', async (req, res) => {
    try {
        ...
        // Criar novo usuário
        const userData = new UserModel_1.UserModel();
