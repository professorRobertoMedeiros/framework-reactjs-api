...
exports.registerSchedulerInstance = registerSchedulerInstance;
const express_1 = require("express");
const JobRepository_1 = require("../core/scheduler/JobRepository");
 ...
 */
function registerSchedulerInstance(scheduler) {
 ...
 */
router.post('/reload', authMiddleware.authenticate(), async (req, res) => {
    try {
        const scheduler = getScheduler();
 ...
 */
router.post('/reload/:id', authMiddleware.authenticate(), async (req, res) => {
    try {
 ...
 * Inicia o scheduler
 */
router.post('/start', authMiddleware.authenticate(), async (req, res) => {
    try {
        const scheduler = getScheduler();
 ...
 * Para o scheduler
 */
router.post('/stop', authMiddleware.authenticate(), async (req, res) => {
    try {
        const scheduler = getScheduler();
 ...
 */
router.post('/jobs/:id/run', authMiddleware.authenticate(), async (req, res) => {
    try {
        const jobId = Number(req.params.id);
        const scheduler = getScheduler();
 ...
 * Lista todos os jobs
 */
router.get('/jobs', authMiddleware.authenticate(), async (req, res) => {
    try {
        ...
        if (enabled !== undefined) {
            ...
            jobs = await jobRepository.findByLastStatus(status);
        }
        else {
 ...
 */
router.get('/jobs/:id', authMiddleware.authenticate(), async (req, res) => {
    try {
        const jobId = Number(req.params.id);
 ...
 * Cria um novo job
 */
router.post('/jobs', authMiddleware.authenticate(), async (req, res) => {
    try {
 ...
 */
router.put('/jobs/:id', authMiddleware.authenticate(), async (req, res) => {
    try {
        const jobId = Number(req.params.id);
        const jobData = req.body;
 ...
 * Deleta um job
 */
router.delete('/jobs/:id', authMiddleware.authenticate(), async (req, res) => {
    try {
        const jobId = Number(req.params.id);
 ...
 * Habilita um job
 */
router.post('/jobs/:id/enable', authMiddleware.authenticate(), async (req, res) => {
    try {
        const jobId = Number(req.params.id);
 ...
 * Desabilita um job
 */
router.post('/jobs/:id/disable', authMiddleware.authenticate(), async (req, res) => {
    try {
        const jobId = Number(req.params.id);
 ...
 */
router.post('/jobs/:id/reset-stats', authMiddleware.authenticate(), async (req, res) => {
    try {
        const jobId = Number(req.params.id);
 ...
 * Lista jobs travados
 */
router.get('/jobs/stuck', authMiddleware.authenticate(), async (req, res) => {
    try {
